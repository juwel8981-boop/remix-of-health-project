...
import { Search, CheckCircle2, XCircle, Shield, AlertCircle, User, Building2, GraduationCap, Calendar, Stethoscope } from "lucide-react";
...
export default function VerifyDoctorForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="font-display text-xl font-bold text-foreground">Verify Doctor</h2>
          <p className="text-sm text-muted-foreground">Bangladesh Medical & Dental Council (BM&DC)</p>
        </div>
      </div>
      ...
      <div className="healthcare-card">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1 flex items-center gap-3 px-4 py-3 rounded-xl border border-input bg-background focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all">
