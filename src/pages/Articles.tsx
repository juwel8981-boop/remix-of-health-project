                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {post.isDoctor && (
                            <motion.span 
                              ...
                              className="inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full bg-primary/5 text-primary/80 border border-primary/10"
                            >
                        ...
                        {post.isDoctor ? (
                          ...
                          >
                            ...
                            {post.doctorRegistration && (
                              <span className="inline-flex items-center gap-1 text-primary/60 font-mono text-[10px] font-bold bg-primary/5 px-2 py-1 rounded border border-primary/10">
